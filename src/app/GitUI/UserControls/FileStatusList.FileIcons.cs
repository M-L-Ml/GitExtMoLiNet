...
partial class FileStatusList
{
    private void LoadFileIcons(IEnumerable<TreeNode> nodes, CancellationToken cancellationToken)
    {
        ...
        {
            ThreadHelper.RunAndFileAndForget(() => LoadFileIconsAsync(missingIconsByExtension, fileName => _iconProvider.Get(workingDir, fileName), _imageListData.ImageList.ImageSize, FileStatusListView, cancellationToken));
        }
