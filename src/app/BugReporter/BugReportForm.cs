...
{
    public partial class BugReportForm : Form2, ITranslate
    {
...
Send report?");
        ...
        private void SendAndQuitButton_Click(object sender, EventArgs e)
        {
            ...
            string? url = UrlBuilder.Build("https://github.com/M-L-Ml/GitExtMoLiNet/issues/new", _lastException, _exceptionInfo, _environmentInfo, descriptionTextBox.Text);
